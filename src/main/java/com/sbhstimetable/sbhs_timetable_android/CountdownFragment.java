...
public class CountdownFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (ThemeHelper.isBackgroundDark()) {
            f.setProgressBackgroundColorSchemeResource(R.color.background_floating_dark);
        } else {
            f.setProgressBackgroundColorSchemeResource(R.color.background_floating_light);
        }
    ...
    public void updateTimer(final View f) {
        ...
        CountDownTimer timer = new CountDownTimer(millisToCountfor, 1000) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                secondsLeft /= 60;
                if (secondsLeft == 0) {
                    t.setText(String.format(Locale.US, "%02dm %02ds", new Object[]{minutes, seconds}));
                } else {
                    t.setText(String.format(Locale.US, "%02dh %02dm %02ds", new Object[]{secondsLeft, minutes, seconds}));
                }
            }
